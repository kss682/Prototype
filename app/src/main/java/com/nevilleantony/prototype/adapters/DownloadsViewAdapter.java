...
public class DownloadsViewAdapter extends RecyclerView.Adapter<DownloadsViewAdapter.DownloadsViewHolder> {
    ...
    private List<FileDownload> downloads = new ArrayList<>();
    private Intent downloadIntent;
    private Context context;

    public DownloadsViewAdapter(Context context, Collection<FileDownload> fileDownloadList) {
        this.downloads.addAll(fileDownloadList);
